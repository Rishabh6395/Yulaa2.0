    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-surface-400 dark:text-gray-500 mt-0.5">Mark and view daily attendance</p>
        </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="font-display font-semibold text-gray-900 dark:text-gray-100">{cls.grade} - {cls.section}</span>
      ...
      {selectedClass && (
        <div className="card p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Mark Attendance</h3>
