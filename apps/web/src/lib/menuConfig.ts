...
export const menuItems: Record<string, MenuItem[]> = {
  super_admin: [
    ...
    { label: 'Form Config',             href: '/dashboard/super-admin/form-config',             icon: 'FileText',      key: 'super_form_config' },
    { label: 'KPI Config',              href: '/dashboard/super-admin/kpi-config',              icon: 'TrendingUp',    key: 'super_kpi_config' },
    { label: 'Admission Workflow',      href: '/dashboard/admissions/workflow',                 icon: 'GitBranch',     key: 'admission_workflow' },
    { label: 'Users',                   href: '/dashboard/users',                               icon: 'Users',         key: 'super_users' },
    { label: 'Masters',                 href: '/dashboard/masters',                             icon: 'Database',      key: 'super_masters' },
    { label: 'Reports',                 href: '/dashboard/reports',                             icon: 'BarChart',      key: 'super_reports' },
    { label: 'Profile',                 href: '/dashboard/settings',                            icon: 'UserCircle',    key: 'super_settings' },
  ],
  school_admin: [
