...
const ALL_FEATURES: Feature[] = [
  ...
  { label: 'Class Diary',      emoji: '📓', route: '/(app)/diary',                  roles: ['school_admin','principal','teacher','student','parent','hod'] },
  ...
  { label: 'Board Exam',       emoji: '🎓', route: '/(app)/board-exam-tracker',     roles: ['school_admin','principal','teacher','student','hod'] },
  { label: 'Report Cards',     emoji: '📊', route: '/(app)/report-cards',           roles: ['school_admin','principal','teacher','student','parent','hod'] },
  { label: 'Performance',      emoji: '📈', route: '/(app)/performance',            roles: ['school_admin','principal','teacher','parent','hod'] },
  // Attendance
  { label: 'Gate Pass',        emoji: '🚪', route: '/(app)/gate-pass',              roles: ['school_admin','principal','teacher','hod'] },
  { label: 'Regularization',   emoji: '🔄', route: '/(app)/regularization',         roles: ['school_admin','principal','teacher','hod','employee'] },
  // Communication
  ...
  { label: 'Hostel',           emoji: '🏨', route: '/(app)/hostel',                 roles: ['school_admin','principal','student'] },
  { label: 'Library',          emoji: '📚', route: '/(app)/library',                roles: ['school_admin','principal','teacher','student'] },
  { label: 'My Payslips',      emoji: '💼', route: '/(app)/hrms',                   roles: ['teacher','employee','hod'] },
  { label: 'Payroll',          emoji: '💰', route: '/(app)/hrms',                   roles: ['school_admin','principal'] },
